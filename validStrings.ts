/**
 * As neat as ts is, the fact there's no access to type definitions
 * at runtime means I have to include something like this...
 */

export const meType: Array<string> = [
...
export const tagContext: Array<string> = [
  "AWS",
  "AWS_GENERIC",
  "AZURE",
  "CLOUD_FOUNDRY",
